...
public final class UserRepositoryModule_ProvideUserRemoteDataSourceFactory
  ...
  public UserRepositoryModule_ProvideUserRemoteDataSourceFactory(
  ...
  public UserDataSource get() {
    return Preconditions.checkNotNull(
        module.provideUserRemoteDataSource(contextProvider.get()),
        "Cannot return null from a non-@Nullable @Provides method");
  }

  public static Factory<UserDataSource> create(
      UserRepositoryModule module, Provider<Context> contextProvider) {
    return new UserRepositoryModule_ProvideUserRemoteDataSourceFactory(module, contextProvider);
  }
}
