...
public class MainActivity$$ViewBinder<T extends MainActivity> extends AbstractBaseActivity$$ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131492990, "field 'fabAddContact' and method 'onClick'");
    target.fabAddContact = finder.castView(view, 2131492990, "field 'fabAddContact'");
    ...
    view = finder.findRequiredView(source, 2131492994, "field 'swipeRefreshLayout'");
    target.swipeRefreshLayout = finder.castView(view, 2131492994, "field 'swipeRefreshLayout'");
    view = finder.findRequiredView(source, 2131492996, "field 'rvContacts'");
    target.rvContacts = finder.castView(view, 2131492996, "field 'rvContacts'");
    ...
    view = finder.findRequiredView(source, 2131492993, "field 'flContainer'");
    target.flContainer = finder.castView(view, 2131492993, "field 'flContainer'");
    view = finder.findRequiredView(source, 2131492991, "field 'tvEmptyText'");
    target.tvEmptyText = finder.castView(view, 2131492991, "field 'tvEmptyText'");
    return unbinder;
  }
