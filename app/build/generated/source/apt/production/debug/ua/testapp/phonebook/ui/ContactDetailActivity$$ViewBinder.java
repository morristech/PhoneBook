...
public class ContactDetailActivity$$ViewBinder<T extends ContactDetailActivity> extends AbstractBaseActivity$$ViewBinder<T> {
  @Override
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131492982, "method 'onClick'");
  ...
  protected static class InnerUnbinder<T extends ContactDetailActivity> extends AbstractBaseActivity$$ViewBinder.InnerUnbinder<T> {
    View view2131492982;
